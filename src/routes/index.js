...
const {getAirports, createAirport, updateAirport, deleteAirport, getAirport, addAirline, getAirportBycountry, defuseAirport} = require('../controllers/airports.controllers.js');
